...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/AryanHack907/J-king/blob/main/Joya.txt"])
	exit(" [*] FACEBOOK :  https://youtube.com/channel/UCZh58ed2U8hZ6_-_WV77DZA")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN Aryan")
	subprocess.check_output(["am", "start", "https://youtube.com/channel/UCZh58ed2U8hZ6_-_WV77DZA"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/AryanHack907/J-king/blob/main/Joya.txt').text
			if basesplit in plr:
				key = basesplit
...
\33[1;34m█▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█
\33[1;34m█  \33[mGithub: https://github.com/\33[1;32mAryanHack907
\33[1;34m█  \33[mTelegram : \33[1;32mParwiz Hack
\33[1;34m█  \33[mModifier: \33[1;32m Nikzaad
\33[1;34m█  \33[mTools : \33[1;32m JOYA-907
\33[1;34m█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█
    """)
		print("%s [%s•%s] %sTOOL NAME : %sSuper Speed Uid Joya-907-af"%(G,R,G,B,G))
